...
class Book(models.Model):
    title: models.CharField = models.CharField(max_length=30, verbose_name='Название книги')
    genre: models.CharField = models.CharField(max_length=30, verbose_name='Жанр')
    ...
    pages: models.IntegerField = models.IntegerField(verbose_name='Количество страниц')
...
class Author(models.Model):
    surname: models.CharField = models.CharField(max_length=30, verbose_name='Фамилия')
    name: models.CharField = models.CharField(max_length=30, verbose_name='Имя')
    patronymic: models.CharField = models.CharField(max_length=30, verbose_name='Отчество')
    birthday = models.CharField(
        max_length=10,
        validators=[RegexValidator(r'^\d{2}\.\d{2}\.\d{4}$', 'Дата должна быть в формате dd.mm.yyyy')]
